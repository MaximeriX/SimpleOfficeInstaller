...
document.querySelector('.start-button').addEventListener('click', () => {
    ...
    if (validateForm()) {
        ...
        if (isTeamsSelected) {
            ...
            startButton.textContent = "Інсталятор Teams запущено...";
            ...
            startButton.textContent = "Інсталятор Office запущено...";
        }
        if (isAnyAppSelected) {
            const tempDir = window.electron.path.join(window.electron.os.tmpdir(), 'OfficeSetupFiles');
        ...
        setTimeout(() => {
            startButton.textContent = "Запустити інсталятор Office";
...
document.getElementById('edition').addEventListener('change', function() {
    ...
    checkboxes.forEach(checkbox => {
        ...
        if (VisioSelected) {
            ...
            projectEdition.innerHTML = '<option value="" disabled selected>-- Виберіть --</option>';
        } else {
        ...
        if (ProjectSelected) {
            ...
            visioEdition.innerHTML = '<option value="" disabled selected>-- Виберіть --</option>';
        } else {
...
function updateEditions() {
    ...
    editionSelect.innerHTML = '<option value="" disabled selected>-- Виберіть --</option>';
    additionalProductsSelect.innerHTML = '<option value="" selected>Ніякі</option>';
    ...
    if (selectedVersion === 'office-365') {
        ...
        editions = [
            ...
            { value: 'enterprise-no-teams', text: 'Enterprise (без Teams)' },
            { value: 'business', text: 'Business' },
            { value: 'business-no-teams', text: 'Business (без Teams)' }
        ];
        additionalProducts = [
            { value: 'language-pack', text: 'Мовний пакет' },
            { value: 'office-365-access-runtime', text: 'Office 365 Access Runtime' }
        ];
    } else if (selectedVersion === 'office-2024') {
        editions = [
            { value: 'ltsc-pro-plus-vl', text: 'LTSC Professional Plus - КЛ' },
            { value: 'pro-plus-vl', text: 'Professional Plus - КЛ' },
            { value: 'ltsc-stand-vl', text: 'LTSC Standard - КЛ' }
        ];
        teamsCheckbox.disabled = false;
        ...
        editions = [
            { value: 'ltsc-pro-plus-vl', text: 'LTSC Professional Plus - КЛ' },
            { value: 'pro-plus-vl', text: 'Professional Plus - КЛ' },
            { value: 'pro-vl', text: 'Professional - КЛ' },
            { value: 'ltsc-stand-vl', text: 'LTSC Standard - КЛ' },
            { value: 'stand-vl', text: 'Standard - КЛ' }
        ];
        teamsCheckbox.disabled = false;
        additionalProducts = [
            { value: 'language-pack', text: 'Мовний пакет' },
        ...
        editions = [
            { value: 'pro-plus-rl', text: 'Professional Plus - РЛ' },
            { value: 'pro-rl', text: 'Professional - РЛ' },
            { value: 'stand-rl', text: 'Standard - РЛ' }
        ];
        teamsCheckbox.disabled = false;
    }
    ...
    if (!selectedVersion) {
        checkboxes.forEach(checkbox => {
            ...
            document.getElementById('project-edition').disabled = true;
            document.getElementById('visio-edition').disabled = true;
            document.getElementById('project-edition').innerHTML = '<option value="" disabled selected>-- Виберіть --</option>';
            document.getElementById('visio-edition').innerHTML = '<option value="" disabled selected>-- Виберіть --</option>';
...
function updateProjectEditions() {
    ...
    if (version === 'office-365') {
        options = [
            ...
            { value: 'pro-2024-vl', text: 'Professional 2024 - Активований, КЛ' },
            { value: 'stand-2024-vl', text: 'Standard 2024 - Активований, КЛ' },
            { value: 'pro-2021-vl', text: 'Professional 2021 - Активований, КЛ' },
            { value: 'stand-2021-vl', text: 'Standard 2021 - Активований, КЛ' },
            { value: 'pro-2019-vl', text: 'Professional 2019 - Активований, КЛ' },
            { value: 'stand-2019-vl', text: 'Standard 2019 - Активований, КЛ' },
            { value: 'pro-2016-vl', text: 'Professional 2016 - Активований, КЛ' },
            { value: 'stand-2016-vl', text: 'Standard 2016 - Активований, КЛ' }
        ];
...
function updateVisioEditions() {
    ...
    if (version === 'office-365') {
        options = [
            ...
            { value: 'ltsc-pro-2024-vl', text: 'LTSC Professional 2024 - Активований, КЛ' },
            { value: 'ltsc-stand-2024-vl', text: 'LTSC Standard 2024 - Активований, КЛ' },
            { value: 'ltsc-pro-2021-vl', text: 'LTSC Professional 2021 - Активований, КЛ' },
            { value: 'ltsc-stand-2021-vl', text: 'LTSC Standard 2021 - Активований, КЛ' },
            { value: 'ltsc-pro-2019-vl', text: 'LTSC Professional 2019 - Активований, КЛ' },
            { value: 'ltsc-stand-2019-vl', text: 'LTSC Standard 2019 - Активований, КЛ' },
            { value: 'pro-2016-vl', text: 'Professional 2016 - Активований, КЛ' },
            { value: 'stand-2016-vl', text: 'Standard 2016 - Активований, КЛ' }
        ];        
    } else if (version === 'office-2024') {
